...
impl CodePage {
    ...
    /// - `Page(n)`: los caracteres ASCII pasan directamente; los no-ASCII se reemplazan por `?`
    ///   (el usuario debe pre-encodificar el texto si necesita caracteres especiales).
